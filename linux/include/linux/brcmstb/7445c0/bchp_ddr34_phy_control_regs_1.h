...
/***************************************************************************
 *DDR34_PHY_CONTROL_REGS_1 - 1 DDR34 DDR34 Address/Comand control registers
 ***************************************************************************/
...
#define BCHP_DDR34_PHY_CONTROL_REGS_1_DRIVE_PAD_CTL 0x01186038 /* PVT Compensation control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_STATIC_PAD_CTL 0x0118603c /* pad rx and tx characteristics control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_DRAM_CONFIG 0x01186040 /* DRAM configuration register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_DRAM_TIMING1 0x01186044 /* DRAM timing register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_DRAM_TIMING2 0x01186048 /* DRAM timing register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_DRAM_TIMING3 0x0118604c /* DRAM timing register #3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_DRAM_TIMING4 0x01186050 /* DRAM timing register #4 */
...
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD00 0x01186090 /* DDR interface signal AD[00] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD01 0x01186094 /* DDR interface signal AD[01] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD02 0x01186098 /* DDR interface signal AD[02] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD03 0x0118609c /* DDR interface signal AD[03] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD04 0x011860a0 /* DDR interface signal AD[04] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD05 0x011860a4 /* DDR interface signal AD[05] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD06 0x011860a8 /* DDR interface signal AD[06] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD07 0x011860ac /* DDR interface signal AD[07] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD08 0x011860b0 /* DDR interface signal AD[08] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD09 0x011860b4 /* DDR interface signal AD[09] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD10 0x011860b8 /* DDR interface signal AD[10] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD11 0x011860bc /* DDR interface signal AD[11] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD12 0x011860c0 /* DDR interface signal AD[12] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD13 0x011860c4 /* DDR interface signal AD[13] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD14 0x011860c8 /* DDR interface signal AD[14] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AD15 0x011860cc /* DDR interface signal AD[15] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_BA0 0x011860d0 /* DDR interface signal BA[0] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_BA1 0x011860d4 /* DDR interface signal BA[1] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_BA2 0x011860d8 /* DDR interface signal BA[2] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AUX0 0x011860dc /* DDR interface signal AUX[0] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AUX1 0x011860e0 /* DDR interface signal AUX[1] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_AUX2 0x011860e4 /* DDR interface signal AUX[2] VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_CS0 0x011860e8 /* DDR interface signal CS0 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_CS1 0x011860ec /* DDR interface signal CS1 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_PAR 0x011860f0 /* DDR interface signal PAR VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_RAS_N 0x011860f4 /* DDR interface signal RAS_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_CAS_N 0x011860f8 /* DDR interface signal CAS_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_CKE 0x011860fc /* DDR interface signal CKE0 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_RST_N 0x01186100 /* DDR interface signal RST_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_ODT 0x01186104 /* DDR interface signal ODT0 VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_WE_N 0x01186108 /* DDR interface signal WE_N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_DDR_CK_P 0x0118610c /* DDR interface signal DDR_CK-P VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CONTROL_DDR_CK_N 0x01186110 /* DDR interface signal DDR_CK-N VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_CLK_CONTROL 0x01186114 /* DDR interface signal Write Leveling CLK VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VDL_LDE_CONTROL 0x01186118 /* DDR interface signal Write Leveling Capture Enable VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_REFRESH    0x01186130 /* Refresh engine controller */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_UPDATE_VDL 0x01186134 /* Update VDL control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_UPDATE_VDL_SNOOP1 0x01186138 /* Update VDL snoop control register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_UPDATE_VDL_SNOOP2 0x0118613c /* Update VDL snoop control register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_COMMAND_REG1 0x01186140 /* DRAM Command Register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_COMMAND_AUX_REG1 0x01186144 /* DRAM AUX_N Command Register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_COMMAND_REG2 0x01186148 /* DRAM Command Register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_COMMAND_AUX_REG2 0x0118614c /* DRAM AUX_N Command Register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_COMMAND_REG3 0x01186150 /* DRAM Command Register #3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_COMMAND_AUX_REG3 0x01186154 /* DRAM AUX_N Command Register #3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_COMMAND_REG4 0x01186158 /* DRAM Command Register #4 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_COMMAND_AUX_REG4 0x0118615c /* DRAM AUX_N Command Register #4 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_COMMAND_REG_TIMER 0x01186160 /* DRAM Command Timer Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_MODE_REG0  0x01186164 /* DDR3/DDR4/GDDR5 Mode Register 0 and LPDDR Mode Register 1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_MODE_REG1  0x01186168 /* DDR3/DDR4/GDDR5 Mode Register 1 and LPDDR Mode Register 2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_MODE_REG2  0x0118616c /* DDR3/DDR4/GDDR5 Mode Register 2 and LPDDR Mode Register 3 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_MODE_REG3  0x01186170 /* DDR3/DDR4/GDDR5 Mode Register 3 and LPDDR Mode Register 9 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_MODE_REG4  0x01186174 /* DDR4/GDDR5 Mode Register 4 and LPDDR Mode Register 10 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_MODE_REG5  0x01186178 /* DDR4/GDDR5 Mode Register 5 and LPDDR Mode Register 16 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_MODE_REG6  0x0118617c /* DDR4/GDDR5 Mode Register 6 and LPDDR Mode Register 17 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_MODE_REG7  0x01186180 /* DDR4/GDDR5 Mode Register 7 and LPDDR Mode Register 41 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_MODE_REG8  0x01186184 /* GDDR5 Mode Register 8 and LPDDR Mode Register 42 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_MODE_REG15 0x01186188 /* GDDR5 Mode Register 15 and LPDDR Mode Register 48 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_MODE_REG63 0x0118618c /* LPDDR Mode Register 63 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_ALERT_CLEAR 0x01186190 /* DDR4 Alert status clear register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_ALERT_STATUS 0x01186194 /* DDR4 Alert status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_CA_PARITY  0x01186198 /* DDR4 CA parity control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_CA_PLAYBACK_CONTROL 0x0118619c /* GDDR5 CA playback control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_CA_PLAYBACK_STATUS0 0x011861a0 /* LPDDR3 and GDDR5 CA playback status register0 (for BL0 and BL1) */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_CA_PLAYBACK_STATUS1 0x011861a4 /* LPDDR3 and GDDR5 CA playback status register1 (for BL2 and BL3) */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_WRITE_LEVELING_CONTROL 0x011861ac /* Write leveling control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_WRITE_LEVELING_STATUS 0x011861b0 /* Write leveling status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_READ_ENABLE_CONTROL 0x011861b4 /* Read enable test cycle control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_READ_ENABLE_STATUS 0x011861b8 /* Read enable test cycle status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_TRAFFIC_GEN_LFSR_SEED 0x011861c0 /* Traffic generator seed register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_TRAFFIC_GEN_ADDRESS1 0x011861c4 /* Traffic generator address register #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_TRAFFIC_GEN_ADDRESS2 0x011861c8 /* Traffic generator address register #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_TRAFFIC_GEN_CONTROL 0x011861cc /* Traffic generator control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_TRAFFIC_GEN_DATA_CONTROL 0x011861d0 /* Traffic generator data control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_TRAFFIC_GEN_DQ_MASK 0x011861d4 /* Traffic generator DQ mask register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_TRAFFIC_GEN_ECC_DQ_MASK 0x011861d8 /* Traffic generator ECC DQ mask register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_TRAFFIC_GEN_STATUS 0x011861dc /* Traffic generator status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_TRAFFIC_GEN_DQ_STATUS 0x011861e0 /* Traffic generator DQ status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_TRAFFIC_GEN_ECC_STATUS 0x011861e4 /* Traffic generator ECC DQ status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_TRAFFIC_GEN_ERR_CNT_CONTROL 0x011861e8 /* Traffic generator error count control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_TRAFFIC_GEN_ERR_CNT_STATUS 0x011861ec /* Traffic generator error count status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VIRTUAL_VTT_CONTROL 0x011861f0 /* Virtual VTT Control and Status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VIRTUAL_VTT_STATUS 0x011861f4 /* Virtual VTT Control and Status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VIRTUAL_VTT_CONNECTIONS 0x011861f8 /* Virtual VTT Connections register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VIRTUAL_VTT_OVERRIDE 0x011861fc /* Virtual VTT Override register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_VREF_DAC_CONTROL 0x01186200 /* VREF DAC Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_PHYBIST_CNTRL 0x01186204 /* PhyBist Control Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_PHYBIST_SEED 0x01186208 /* PhyBist Seed Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_PHYBIST_STATUS 0x0118620c /* PhyBist General Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_PHYBIST_CTL_STATUS 0x01186210 /* PhyBist Per-Bit Control Pad Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_PHYBIST_BL0_STATUS 0x01186214 /* PhyBist Byte Lane #0 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_PHYBIST_BL1_STATUS 0x01186218 /* PhyBist Byte Lane #1 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_PHYBIST_BL2_STATUS 0x0118621c /* PhyBist Byte Lane #2 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_PHYBIST_BL3_STATUS 0x01186220 /* PhyBist Byte Lane #3 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_PHYBIST_BL4_STATUS 0x01186224 /* PhyBist Byte Lane #4 (ECC) Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_STANDBY_CONTROL 0x01186230 /* Standby Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_DEBUG_FREEZE_ENABLE 0x01186234 /* Freeze-on-error enable register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_DEBUG_MUX_CONTROL 0x01186238 /* Debug Mux Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_DFI_CNTRL  0x0118623c /* DFI Interface Ownership Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_WRITE_ODT_CNTRL 0x01186240 /* Write ODT Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_ABI_PAR_CNTRL 0x01186244 /* ABI and PAR Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_ZQ_CAL     0x01186248 /* ZQ Calibration Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_1_AC_SPARE_REG 0x0118611c /* Address and Control Spare register */
