...
#define BCHP_SHIMPHY_ADDR_CNTL_0_PHY_STANDBY_EXIT 0x0110804c /* DDR PHY standby exit register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_ANALOG_BYPASS_CNTRL 0x0110806c /* Analog macro register bypass control */
#define BCHP_SHIMPHY_ADDR_CNTL_0_DDR_PLL_EXT_CLKSEL 0x01108070 /* DDR PLL external clock select register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_TEST_MODE_CNTRL_REG 0x01108074 /* SHIMPHY testport control register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_DISABLE_CHIP_BYPASS_PLL 0x0110807c /* DDR bypass pll mode disable register. */
#define BCHP_SHIMPHY_ADDR_CNTL_0_VECTOR_MODE_CLK_SEL 0x01108088 /* DDR VECTOR PLL bypass mode clock select */
#define BCHP_SHIMPHY_ADDR_CNTL_0_DDR_PAD_CNTRL   0x0110808c /* DDR Pad control register */
#define BCHP_SHIMPHY_ADDR_CNTL_0_CLK_GATE        0x01108098 /* CLK_667_ENABLE Register */
