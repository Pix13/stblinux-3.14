...
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRIVE_PAD_CTL 0x01106038 /* Address/Control PVT Compensation control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DRIVE_PAD_CTL_2T 0x0110603c /* Address/Control PVT Compensation control for signals that are 1T when in 2T mode */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_STATIC_PAD_CTL 0x01106040 /* pad rx and tx characteristics control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_STATIC_PAD_CTL_2T 0x01106044 /* pad rx and tx characteristics control register for signals that are 1T when in 2T mode */
...
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CA_PARITY  0x0110617c /* DDR4 CA parity control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CA_PLAYBACK_CONTROL 0x01106180 /* GDDR5 CA playback control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CA_PLAYBACK_STATUS0 0x01106184 /* LPDDR3 and GDDR5 CA playback status register0 (for BL0 and BL1) */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CA_PLAYBACK_STATUS1 0x01106188 /* LPDDR3 and GDDR5 CA playback status register1 (for BL2 and BL3) */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_WRITE_LEVELING_CONTROL 0x0110618c /* Write leveling control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_WRITE_LEVELING_STATUS 0x01106190 /* Write leveling status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_READ_ENABLE_CONTROL 0x01106194 /* Read enable test cycle control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_READ_ENABLE_STATUS 0x01106198 /* Read enable test cycle status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_CONTROL 0x0110619c /* Virtual VTT Control and Status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_STATUS 0x011061a0 /* Virtual VTT Control and Status register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_CONNECTIONS 0x011061a4 /* Virtual VTT Connections register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VIRTUAL_VTT_OVERRIDE 0x011061a8 /* Virtual VTT Override register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VREF_DAC_CONTROL 0x011061ac /* VREF DAC Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_CNTRL 0x011061b0 /* PhyBist Control Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_SEED 0x011061b4 /* PhyBist Seed Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_CA_MASK 0x011061b8 /* PhyBist Command/Address Bus Mask */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_DQ_MASK1 0x011061bc /* PhyBist Data Bus Mask #1 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_DQ_MASK2 0x011061c0 /* PhyBist Data Bus Mask #2 */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_STATUS 0x011061c4 /* PhyBist General Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_CTL_STATUS 0x011061c8 /* PhyBist Per-Bit Control Pad Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL0_STATUS 0x011061cc /* PhyBist Byte Lane #0 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL1_STATUS 0x011061d0 /* PhyBist Byte Lane #1 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL2_STATUS 0x011061d4 /* PhyBist Byte Lane #2 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL3_STATUS 0x011061d8 /* PhyBist Byte Lane #3 Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PHYBIST_BL4_STATUS 0x011061dc /* PhyBist Byte Lane #4 (ECC) Status Register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_STANDBY_CONTROL 0x011061e0 /* Standby Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DEBUG_FREEZE_ENABLE 0x011061e4 /* Freeze-on-error enable register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DEBUG_MUX_CONTROL 0x011061e8 /* Debug Mux Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_DFI_CNTRL  0x011061ec /* DFI Interface Ownership Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_WRITE_ODT_CNTRL 0x011061f0 /* Write ODT Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ABI_PAR_CNTRL 0x011061f4 /* ABI and PAR Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ZQ_CAL     0x011061f8 /* ZQ Calibration Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_ZQ_CAL2    0x011061fc /* ZQ Calibration Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_COMR_CAL   0x01106200 /* COMR Calibration Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_RO_PROC_MON_CTL 0x01106204 /* Ring-Osc control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_RO_PROC_MON_STATUS 0x01106208 /* Ring-Osc count register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_CK_DRIVE_PAD_CTL 0x0110620c /* Clock PVT Compensation control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_LDO_COMP_CONTROL 0x01106210 /* LDO Comparator Control register */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_BYTE_LANE_ALIGN_MASKS 0x01106214 /* Byte-lane alignment mask register */
 ...
 ***************************************************************************/
/* DDR34_PHY_CONTROL_REGS_0 :: PLL_CONFIG :: reserved0 [31:30] */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_reserved0_MASK    0xc0000000
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_reserved0_SHIFT   30

/* DDR34_PHY_CONTROL_REGS_0 :: PLL_CONFIG :: PLL_LDO_DVDD1P0V_OUTPUT_V [29:28] */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_PLL_LDO_DVDD1P0V_OUTPUT_V_MASK 0x30000000
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_PLL_LDO_DVDD1P0V_OUTPUT_V_SHIFT 28
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_PLL_LDO_DVDD1P0V_OUTPUT_V_DEFAULT 0x00000001

/* DDR34_PHY_CONTROL_REGS_0 :: PLL_CONFIG :: PLL_LDO_AVDD1P0V_OUTPUT_V [27:26] */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_PLL_LDO_AVDD1P0V_OUTPUT_V_MASK 0x0c000000
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_PLL_LDO_AVDD1P0V_OUTPUT_V_SHIFT 26
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_PLL_LDO_AVDD1P0V_OUTPUT_V_DEFAULT 0x00000001

/* DDR34_PHY_CONTROL_REGS_0 :: PLL_CONFIG :: PLL_LDO_DVDD1P0V_BLEEDING_I [25:24] */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_PLL_LDO_DVDD1P0V_BLEEDING_I_MASK 0x03000000
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_PLL_LDO_DVDD1P0V_BLEEDING_I_SHIFT 24
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_PLL_LDO_DVDD1P0V_BLEEDING_I_DEFAULT 0x00000001

/* DDR34_PHY_CONTROL_REGS_0 :: PLL_CONFIG :: PLL_LDO_AVDD1P0V_BLEEDING_I [23:22] */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_PLL_LDO_AVDD1P0V_BLEEDING_I_MASK 0x00c00000
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_PLL_LDO_AVDD1P0V_BLEEDING_I_SHIFT 22
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_PLL_LDO_AVDD1P0V_BLEEDING_I_DEFAULT 0x00000001

/* DDR34_PHY_CONTROL_REGS_0 :: PLL_CONFIG :: CK_LDO_PWRDOWN [21:21] */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_CK_LDO_PWRDOWN_MASK 0x00200000
#define BCHP_DDR34_PHY_CONTROL_REGS_0_PLL_CONFIG_CK_LDO_PWRDOWN_SHIFT 21
 ...
 ***************************************************************************/
/* DDR34_PHY_CONTROL_REGS_0 :: AUX_CONTROL :: reserved0 [31:04] */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_AUX_CONTROL_reserved0_MASK   0xfffffff0
#define BCHP_DDR34_PHY_CONTROL_REGS_0_AUX_CONTROL_reserved0_SHIFT  4
...
/* DDR34_PHY_CONTROL_REGS_0 :: VDL_MONITOR_STATUS :: reserved2 [03:03] */
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_STATUS_reserved2_MASK 0x00000008
#define BCHP_DDR34_PHY_CONTROL_REGS_0_VDL_MONITOR_STATUS_reserved2_SHIFT 3
